    ...
    >
      ...
      <div className="p-4 border-t border-slate-200">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full flex items-center space-x-3 px-3 py-2.5 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors"
        >
      ...
      <div className="p-4 border-t border-slate-200">
        <motion.button
          whileHover={{ x: 4 }}
          whileTap={{ scale: 0.98 }}
          className="w-full flex items-center space-x-3 px-3 py-2.5 text-slate-600 hover:bg-slate-50 hover:text-slate-800 rounded-lg transition-colors"
        >
